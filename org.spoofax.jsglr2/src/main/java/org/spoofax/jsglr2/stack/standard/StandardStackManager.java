...
public class StandardStackManager<ParseForest extends AbstractParseForest> extends StackManager<StandardStackNode<ParseForest>, ParseForest> {
    ...
    public StandardStackNode<ParseForest> createInitialStackNode(Parse<StandardStackNode<ParseForest>, ParseForest> parse, ISGLRState state) {
    ...
    public StandardStackNode<ParseForest> createStackNode(Parse<StandardStackNode<ParseForest>, ParseForest> parse, ISGLRState state) {
        StandardStackNode<ParseForest> newStackNode = new StandardStackNode<ParseForest>(parse.stackNodeCount++, state);
