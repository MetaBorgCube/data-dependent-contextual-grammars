...
public class ElkhoundStackManager<ParseForest extends AbstractParseForest> extends StackManager<ElkhoundStackNode<ParseForest>, ParseForest> {
    ...
    public ElkhoundStackNode<ParseForest> createInitialStackNode(Parse<ElkhoundStackNode<ParseForest>, ParseForest> parse, ISGLRState state) {
    ...
    public ElkhoundStackNode<ParseForest> createStackNode(Parse<ElkhoundStackNode<ParseForest>, ParseForest> parse, ISGLRState state) {
