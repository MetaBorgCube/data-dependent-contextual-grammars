...
import org.spoofax.jsglr2.parseforest.datadependent.DDStrategoImploder;
import org.spoofax.jsglr2.parseforest.datadependent.DataDependentParseForest;
import org.spoofax.jsglr2.parseforest.datadependent.DataDependentParseForestManager;
...
import org.spoofax.jsglr2.parser.DataDependentReducer;
...
public class JSGLR2Variants {
    ...
    public enum ParseForestRepresentation {
        SymbolRule, Hybrid, DataDependent
    }
    ...
    public static Parser<?, ?, ?, ?> getParser(ISGLRParseTable parseTable, ParseForestRepresentation parseForestRepresentation, boolean elkhoundStack, boolean elkhoundReducing) {
        ...
        switch (parseForestRepresentation) {
            ...
            case DataDependent:
                ...
                StackManager<StandardStackNode<DataDependentParseForest>, DataDependentParseForest> ddStandardStackManager = new StandardStackManager<DataDependentParseForest>();
                DataDependentReducer<StandardStackNode<DataDependentParseForest>, DataDependentParseForest, DataDependentSymbolNode, DataDependentRuleNode> ddReducer = new DataDependentReducer<StandardStackNode<DataDependentParseForest>, DataDependentParseForest, DataDependentSymbolNode, DataDependentRuleNode>(parseTable, ddStandardStackManager, ddParseForestManager);
                
                return new Parser<StandardStackNode<DataDependentParseForest>, DataDependentParseForest, DataDependentSymbolNode, DataDependentRuleNode>(parseTable, ddStandardStackManager, ddParseForestManager, ddReducer);
        }
    }
    
    public static List<Parser<?, ?, ?, ?>> allParsers(ISGLRParseTable parseTable) {
    ...
    public static JSGLR2<?, ?, IStrategoTerm> getJSGLR2(ISGLRParseTable parseTable, ParseForestRepresentation parseForestRepresentation, boolean elkhoundStack, boolean elkhoundReducing) throws ParseTableReadException {
        ...
        switch (parseForestRepresentation) {
            ...
            case Hybrid:
                ...
                break;
            case DataDependent:
                imploder = new DDStrategoImploder();
                break;
        }
    ...
    public static List<JSGLR2<?, ?, IStrategoTerm>> allJSGLR2(ISGLRParseTable parseTable) throws ParseTableReadException {
