...
public class SRParseForestManager extends ParseForestManager<SRParseForest, SymbolNode, RuleNode> {
    ...
    public SymbolNode createParseNode(Parse<?, SRParseForest> parse, ISGLRProduction production, RuleNode firstDerivation) {
    ...
    public RuleNode createDerivation(Parse<?, SRParseForest> parse, ISGLRProduction production, ProductionType productionType, List<SRParseForest> parseForests) {
