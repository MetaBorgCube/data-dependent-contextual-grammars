...
public class DataDependentSymbolNode extends DataDependentParseForest {

	public final ISGLRProduction production;
	private final List<DataDependentRuleNode> derivations;
	
	public DataDependentSymbolNode(int nodeNumber, Parse parse, Position startPosition, Position endPosition, ISGLRProduction production) {
